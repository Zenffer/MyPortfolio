...
$uploadDir = dirname(__DIR__, 2) . DIRECTORY_SEPARATOR . 'assets' . DIRECTORY_SEPARATOR . 'img' . DIRECTORY_SEPARATOR . 'content' . DIRECTORY_SEPARATOR . 'photography';
if (!is_dir($uploadDir)) {
...
$ext = $allowed[$mime];
$basename = 'photo_' . time() . '_' . bin2hex(random_bytes(4)) . '.' . $ext;
...
$publicUrl = 'assets/img/content/photography/' . $basename;
