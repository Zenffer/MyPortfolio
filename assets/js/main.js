...
(function() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // Projects are now server-rendered in index.php, so we don't need to load them dynamically
    // This function is disabled to prevent overwriting server-rendered content with links
  });
})();
